...
import SessionHistoryModal from './SessionHistoryModal.jsx';
...
export default function SessionHistory() {
  ...
  const limit = 20;
  const { sessions, loading, error } = useSessions(null, limit, page * limit);
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      {/* Modal para exibir histórico completo */}
      <SessionHistoryModal
